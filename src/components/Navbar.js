...
// Assets
import logoBadge from "../assets/images/Robot.svg";
      ...
      <div className="Navbar__container">
        <Link className="Navbar__link logo" to="/">
          <figure className="Navbar__logo">
            <img src={logoBadge} alt="TechLove logo badge" loading="lazy" />
          </figure>
          <span className="fw-light fs-normal">TechLove</span>
          <span className="fw-bold fs-normal">Conf</span>
        </Link>
